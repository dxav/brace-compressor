//! Causal reconstructed-neighbor scan bindings for float32 and float64 data.

use numpy::{
    ndarray::{ArrayView1, ArrayView3},
    IntoPyArray, PyArray1, PyArray2, PyArrayMethods, PyReadonlyArray1, PyReadonlyArray3,
};
use pyo3::prelude::*;
